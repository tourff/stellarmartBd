            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-4">
                <div className="bg-white rounded-xl shadow-sm p-4 hidden md:grid grid-cols-12 gap-4 text-sm font-semibold text-gray-600">
                  ...
                  return (
                    <div key={item._id || productId} className="bg-white rounded-xl shadow-sm p-4 md:grid grid-cols-12 gap-4 items-center">
                      <div className="col-span-6 flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <button onClick={() => handleRemove(productId)} className="text-red-500 text-sm hover:text-red-700 mt-1 flex items-center gap-1">
